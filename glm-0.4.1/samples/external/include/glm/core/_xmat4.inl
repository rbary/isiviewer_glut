...
/*
    template <typename T> 
    inline _xmat4<T> operator+ (const _xmat4<T>& m, const _xvec4<T>& v)
    {
        return _xmat4<T>(
            m[0] + v,
            m[1] + v,
    ...
    template <typename T> 
    inline _xmat4<T> operator+ (const _xvec4<T>& v, const _xmat4<T>& m)
    {
        return _xmat4<T>(
            m[0] + v,
            m[1] + v,
 ...
 */
    ...
    inline _xmat4<T> operator/ (const _xmat4<T>& m1, const _xmat4<T>& m2)
    {
        ...
        T SubFactor00 = m2[2][2] * m2[3][3] - m2[3][2] * m2[2][3];
        T SubFactor01 = m2[2][1] * m2[3][3] - m2[3][1] * m2[2][3];
        T SubFactor02 = m2[2][1] * m2[3][2] - m2[3][1] * m2[2][2];
        T SubFactor03 = m2[2][0] * m2[3][3] - m2[3][0] * m2[2][3];
        T SubFactor04 = m2[2][0] * m2[3][2] - m2[3][0] * m2[2][2];
        T SubFactor05 = m2[2][0] * m2[3][1] - m2[3][0] * m2[2][1];
        T SubFactor06 = m2[1][2] * m2[3][3] - m2[3][2] * m2[1][3];
        T SubFactor07 = m2[1][1] * m2[3][3] - m2[3][1] * m2[1][3];
        T SubFactor08 = m2[1][1] * m2[3][2] - m2[3][1] * m2[1][2];
        T SubFactor09 = m2[1][0] * m2[3][3] - m2[3][0] * m2[1][3];
        T SubFactor10 = m2[1][0] * m2[3][2] - m2[3][0] * m2[1][2];
        T SubFactor11 = m2[1][1] * m2[3][3] - m2[3][1] * m2[1][3];
        T SubFactor12 = m2[1][0] * m2[3][1] - m2[3][0] * m2[1][1];
        T SubFactor13 = m2[1][2] * m2[2][3] - m2[2][2] * m2[1][3];
        T SubFactor14 = m2[1][1] * m2[2][3] - m2[2][1] * m2[1][3];
        T SubFactor15 = m2[1][1] * m2[2][2] - m2[2][1] * m2[1][2];
        T SubFactor16 = m2[1][0] * m2[2][3] - m2[2][0] * m2[1][3];
        T SubFactor17 = m2[1][0] * m2[2][2] - m2[2][0] * m2[1][2];
        T SubFactor18 = m2[1][0] * m2[2][1] - m2[2][0] * m2[1][1];

        _xmat4<T> Inverse(
            + (m2[1][1] * SubFactor00 - m2[1][2] * SubFactor01 + m2[1][3] * SubFactor02),
            - (m2[1][0] * SubFactor00 - m2[1][2] * SubFactor03 + m2[1][3] * SubFactor04),
            + (m2[1][0] * SubFactor01 - m2[1][1] * SubFactor03 + m2[1][3] * SubFactor05),
            - (m2[1][0] * SubFactor02 - m2[1][1] * SubFactor04 + m2[1][2] * SubFactor05),

            - (m2[0][1] * SubFactor00 - m2[0][2] * SubFactor01 + m2[0][3] * SubFactor02),
            + (m2[0][0] * SubFactor00 - m2[0][2] * SubFactor03 + m2[0][3] * SubFactor04),
            - (m2[0][0] * SubFactor01 - m2[0][1] * SubFactor03 + m2[0][3] * SubFactor05),
            + (m2[0][0] * SubFactor02 - m2[0][1] * SubFactor04 + m2[0][2] * SubFactor05),

            + (m2[0][1] * SubFactor06 - m2[0][2] * SubFactor07 + m2[0][3] * SubFactor08),
            - (m2[0][0] * SubFactor06 - m2[0][2] * SubFactor09 + m2[0][3] * SubFactor10),
            + (m2[0][0] * SubFactor11 - m2[0][1] * SubFactor09 + m2[0][3] * SubFactor12),
            - (m2[0][0] * SubFactor08 - m2[0][1] * SubFactor10 + m2[0][2] * SubFactor12),

            - (m2[0][1] * SubFactor13 - m2[0][2] * SubFactor14 + m2[0][3] * SubFactor15),
            + (m2[0][0] * SubFactor13 - m2[0][2] * SubFactor16 + m2[0][3] * SubFactor17),
            - (m2[0][0] * SubFactor14 - m2[0][1] * SubFactor16 + m2[0][3] * SubFactor18),
            + (m2[0][0] * SubFactor15 - m2[0][1] * SubFactor17 + m2[0][2] * SubFactor18));
